...
var MapColor = map[string]color.RGBA{
	...
	"Selected":             {0x73, 0xa9, 0xad, 0xff}, //248EA9
	"RowAlterColor":        {0xc4, 0xdf, 0xaa, 0xff}, // rgb(245, 245, 245)AEE7E8
	"HeaderColor":          {0x90, 0xc8, 0xac, 0xff}, // rgb(255, 255, 0)28C3D4
	"RowColor":             {0xf5, 0xf0, 0xbb, 0xff}, // rgb(154, 205, 50)FAFDCB
}
